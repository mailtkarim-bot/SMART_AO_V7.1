...
class TestWorkflowsEndpoint:
    ...
    def test_get_workflow_status(self, override_auth_dependency):
    ...
    def test_get_workflow_status_missing_mission(self, override_auth_dependency):
    ...
    def test_execute_workflow(self, override_auth_dependency):
    ...
    def test_execute_workflow_missing_mission(self, override_auth_dependency):
...
class TestWorkflowIntegration:
    ...
    def test_workflow_status_structure(self, override_auth_dependency):
    ...
    def test_workflow_execution_structure(self, override_auth_dependency):
