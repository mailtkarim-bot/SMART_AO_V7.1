"""
SMART_AO V7 - Test unitaire pour VarianteGuardianAgent
===============================================
Tests unitaires de base pour l'agent agent_variante.
...
class TestVarianteGuardianAgent:
    """Tests pour l'agent VarianteGuardianAgent."""
    ...
    def test_agent_class_exists(self):
        """Test que la classe VarianteGuardianAgent existe."""
        agent = VarianteGuardianAgent()
        assert agent is not None
        assert isinstance(agent, VarianteGuardianAgent)
...
class TestVarianteGuardianAgentEdgeCases:
    ...
    def test_agent_multiple_instances(self):
        ...
        agent1 = VarianteGuardianAgent()
        agent2 = VarianteGuardianAgent()
