"""
SMART_AO V7 - Test unitaire pour MateriauxShieldAgent
===============================================
Tests unitaires de base pour l'agent agent_materiaux_shield.
...
class TestMateriauxShieldAgent:
    """Tests pour l'agent MateriauxShieldAgent."""
    ...
    def test_agent_class_exists(self):
        """Test que la classe MateriauxShieldAgent existe."""
        agent = MateriauxShieldAgent()
        assert agent is not None
        assert isinstance(agent, MateriauxShieldAgent)
...
class TestMateriauxShieldAgentEdgeCases:
    ...
    def test_agent_multiple_instances(self):
        ...
        agent1 = MateriauxShieldAgent()
        agent2 = MateriauxShieldAgent()
