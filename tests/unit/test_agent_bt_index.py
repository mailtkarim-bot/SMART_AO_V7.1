"""
SMART_AO V7 - Test unitaire pour BTIndexAgent
===============================================
Tests unitaires de base pour l'agent agent_bt_index.
...
class TestBTIndexAgent:
    """Tests pour l'agent BTIndexAgent."""
    ...
    def test_agent_class_exists(self):
        """Test que la classe BTIndexAgent existe."""
        agent = BTIndexAgent()
        assert agent is not None
        assert isinstance(agent, BTIndexAgent)
...
class TestBTIndexAgentEdgeCases:
