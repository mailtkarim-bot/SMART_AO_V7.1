"""
SMART_AO V7 - Test unitaire pour GMEAgent
===============================================
Tests unitaires de base pour l'agent agent_gme.
...
class TestGMEAgent:
    ...
    def test_agent_class_exists(self):
        """Test que la classe GMEAgent existe."""
        agent = GMEAgent()
        assert agent is not None
        assert isinstance(agent, GMEAgent)
