"""
SMART_AO V7 - Test unitaire pour DC4Agent
===============================================
Tests unitaires de base pour l'agent agent_dc4.
...
class TestDC4Agent:
    ...
    def test_agent_class_exists(self):
        """Test que la classe DC4Agent existe."""
        agent = DC4Agent()
        assert agent is not None
        assert isinstance(agent, DC4Agent)
