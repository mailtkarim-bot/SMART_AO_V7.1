"""
SMART_AO V7 - Test unitaire pour BT01Agent
===============================================
Tests unitaires de base pour l'agent agent_bt01.
...
from app.agents.agent_bt01 import BT01Agent


class TestBT01Agent:
    """Tests pour l'agent BT01Agent."""

    def test_module_import(self):
        """Test que le module s'import correctement."""
        assert BT01Agent is not None

    def test_agent_class_exists(self):
        """Test que la classe BT01Agent existe."""
        agent = BT01Agent()
        assert agent is not None
        assert isinstance(agent, BT01Agent)
