"""
SMART_AO V7 - Test unitaire pour RATAgent
===============================================
Tests unitaires de base pour l'agent agent_rat.
...
class TestRATAgent:
    ...
    def test_agent_class_exists(self):
        """Test que la classe RATAgent existe."""
        agent = RATAgent()
        assert agent is not None
        assert isinstance(agent, RATAgent)
