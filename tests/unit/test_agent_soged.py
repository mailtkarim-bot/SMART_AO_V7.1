"""
SMART_AO V7 - Test unitaire pour SOGEDAgent
===============================================
Tests unitaires de base pour l'agent agent_soged.
...
class TestSOGEDAgent:
    ...
    def test_agent_class_exists(self):
        """Test que la classe SOGEDAgent existe."""
        agent = SOGEDAgent()
        assert agent is not None
        assert isinstance(agent, SOGEDAgent)
