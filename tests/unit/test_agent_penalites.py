"""
SMART_AO V7 - Test unitaire pour PenalitesAgent
===============================================
Tests unitaires de base pour l'agent agent_penalites.
...
class TestPenalitesAgent:
    """Tests pour l'agent PenalitesAgent."""
    ...
    def test_agent_class_exists(self):
        """Test que la classe PenalitesAgent existe."""
        agent = PenalitesAgent()
        assert agent is not None
        assert isinstance(agent, PenalitesAgent)
...
class TestPenalitesAgentEdgeCases:
    ...
    def test_agent_multiple_instances(self):
        ...
        agent1 = PenalitesAgent()
        agent2 = PenalitesAgent()
