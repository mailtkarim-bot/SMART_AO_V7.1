"""
SMART_AO V7 - Test unitaire pour BIMAgent
===============================================
Tests unitaires de base pour l'agent agent_bim.
...
class TestBIMAgent:
    ...
    def test_agent_class_exists(self):
        """Test que la classe BIMAgent existe."""
        agent = BIMAgent()
        assert agent is not None
        assert isinstance(agent, BIMAgent)
